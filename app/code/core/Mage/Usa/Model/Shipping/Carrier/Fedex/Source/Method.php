...
class Mage_Usa_Model_Shipping_Carrier_Fedex_Source_Method
{
    public function toOptionArray()
    {
        ...
        foreach ($fedex->getCode('method') as $k => $v) {
        		//dumb, but we can't modify the module version numbers to run a new setup
        		if(preg_match('/ground/i', $v)) { $v = "Ground (Business)"; }
        		if(preg_match('/home delivery/i', $v)) { $v = "Ground (Home Delivery)"; }
